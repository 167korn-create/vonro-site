...
1. Crée un repo GitHub **public** (ex. `vonro-site`).
2. Ajoute `index.html`, le dossier `images/` et `CNAME` à la racine du repo.
3. Repo → **Settings → Pages** → Source : branche `main`, dossier `/ (root)`.
4. Chez le registrar du domaine vonro.ch, ajoute 4 enregistrements A :
   `185.199.108.153` · `185.199.109.153` · `185.199.110.153` · `185.199.111.153`
5. Propagation DNS : jusqu'à 24h. Ensuite le site est visible sur https://vonro.ch
...
- [ ] Vérifier que le logo (`images/logo.png`) est le bon (V.O.N.R.O échafaudage)
